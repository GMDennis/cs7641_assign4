...
MAPS = {
    ...
    "20x20": [
        ...
        "FFFFFHFFFFFFFFFFHFFF",
        "FFFFFHFFFFFFFFFFHFFF",
        "FFFFFFFFHFFFFFFFHFFF",
        "FFFFFHFFFFHHFFFFHFFF",
        "FFFFFHFFFFFFFFFFHFFF",
        "FFFFFHFFFFFFFFFFHFFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFHFFF",
        "FFFFFFFFFFFFHFFFHFFF",
        "FFFFFFFFFFFFFFFFHFFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFHFFF",
        "FFFFFFFFFFFFFFFFFFFF",
        "FHHFFFFFFFFFFFFFFFFF",
        "FFFFFFFFFFFFFFFFHFFF",
        "FFFHFFFFFFFFFFHHFFFG"
    ]
}
...
class EasyRewardingFrozenLakeEnv(discrete.DiscreteEnv):
    """
    ...
    def __init__(self, desc=None, map_name="4x4", rewarding=True, step_reward=-0.02, hole_reward=-1, is_slippery=True):
        ...
        super(EasyRewardingFrozenLakeEnv, self).__init__(nS, nA, P, isd)
    ...
    def new_instance(self):
        return EasyRewardingFrozenLakeEnv(desc=self.desc, rewarding=self.rewarding, step_reward=self.step_reward,

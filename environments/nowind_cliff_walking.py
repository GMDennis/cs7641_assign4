...
class NoWindCliffWalkingEnv(discrete.DiscreteEnv):
    """
    ...
    def __init__(self, wind_prob=0.1):
        ...
        super(NoWindCliffWalkingEnv, self).__init__(nS, nA, P, isd)
    ...
    def new_instance(self):
        return NoWindCliffWalkingEnv(wind_prob=self.wind_prob)

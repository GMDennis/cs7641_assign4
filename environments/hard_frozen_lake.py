...
class HardRewardingFrozenLakeEnv(discrete.DiscreteEnv):
    """
    ...
    def __init__(self, desc=None, map_name="4x4", rewarding=True, step_reward=-0.02, hole_reward=-1, is_slippery=True):
        ...
        super(HardRewardingFrozenLakeEnv, self).__init__(nS, nA, P, isd)
    ...
    def new_instance(self):
        return HardRewardingFrozenLakeEnv(desc=self.desc, rewarding=self.rewarding, step_reward=self.step_reward,
